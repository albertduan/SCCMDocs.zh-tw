...
###  <a name="a-namebkmksumcapacitya-capacity-planning-for-the-software-update-point"></a><a name="BKMK_SUMCapacity"></a> 軟體更新點的容量規劃  
...
##  <a name="a-namebkmksupinfrastructurea-determine-the-software-update-point-infrastructure"></a><a name="BKMK_SUPInfrastructure"></a> 判斷軟體更新點基礎結構  
 管理中心網站和所有子主要站台必須擁有將部署軟體更新的軟體更新點。 當您在規劃軟體更新點基礎結構時，必須判斷下列相依性：為站台安裝軟體更新點的位置、哪個站台需要可接受來自以網際網路為基礎用戶端通訊的軟體更新點、是否要將軟體更新點設定為 NLB 叢集的軟體更新點，以及次要站台上是否需要軟體更新點。 使用以下各節，判斷軟體更新點基礎結構。  
...
###  <a name="a-namebkmksuplista-software-update-point-list"></a><a name="BKMK_SUPList"></a> 軟體更新點清單  
...
###  <a name="a-namebkmksupswitchinga-software-update-point-switching"></a><a name="BKMK_SUPSwitching"></a> 軟體更新點切換  
...
###  <a name="a-namebkmksupcrossforesta-software-update-points-in-an-untrusted-forest"></a><a name="BKMK_SUP_CrossForest"></a> 不受信任樹系中的軟體更新點  
...
###  <a name="a-namebkmkwsussyncsourcea-use-an-existing-wsus-server-as-the-synchronization-source-at-the-top-level-site"></a><a name="BKMK_WSUSSyncSource"></a> 在頂層站台上使用現有 WSUS 伺服器作為同步處理來源  
...
###  <a name="a-namebkmknlbsupsp1a-software-update-point-configured-to-use-an-nlb"></a><a name="BKMK_NLBSUPSP1"></a> 設定為使用 NLB 的軟體更新點  
 軟體更新點切換可能會解決您的容錯需求。 不過，若是單純的負載平衡，NLB 比軟體更新點容錯移轉更健全，而且 NLB 可以提升可靠性和網路的執行效能。 雖然 Configuration Manager 主控台沒有選項可將軟體更新點設定為使用 NLB，但您可以選擇使用 Set-CMSoftwareUpdatePoint PowerShell Cmdlet 來設定 NLB。 如需 Set-CMSoftwareUpdatePoint PowerShell Cmdlet 的詳細資訊，請參閱 [Set-CMSoftwareUpdatePoint](http://go.microsoft.com/fwlink/?LinkId=276834)。

###  <a name="a-namebkmksupsecsitea-software-update-point-on-a-secondary-site"></a><a name="BKMK_SUPSecSite"></a> 次要站台上的軟體更新點  
...
##  <a name="a-namebkmksupinstallationa-plan-for-software-update-point-installation"></a><a name="BKMK_SUPInstallation"></a> 規劃軟體更新點安裝  
...
###  <a name="a-namebkmksupsystemrequirementsa-requirements-for-the-software-update-point"></a><a name="BKMK_SUPSystemRequirements"></a> 軟體更新點的需求  
...
###  <a name="a-namebkmkplanningforwsusa-plan-for-wsus-installation"></a><a name="BKMK_PlanningForWSUS"></a> 規劃 WSUS 安裝  
...
####  <a name="a-namebkmkcustomwebsitea-configure-wsus-to-use-a-custom-web-site"></a><a name="BKMK_CustomWebSite"></a> 將 WSUS 設定為使用自訂網站  
...
####  <a name="a-namebkmkwsusinfrastructurea-use-an-existing-wsus-infrastructure"></a><a name="BKMK_WSUSInfrastructure"></a> 使用現有 WSUS 基礎結構  
...
####  <a name="a-namebkmkwsusasreplicaa-configure-wsus-as-a-replica-server"></a><a name="BKMK_WSUSAsReplica"></a> 將 WSUS 設定為複本伺服器  
...
####  <a name="a-namebkmkwsusandssla-decide-whether-to-configure-wsus-to-use-ssl"></a><a name="BKMK_WSUSandSSL"></a> 決定是否要將 WSUS 設定為使用 SSL  
...
###  <a name="a-namebkmkconfigurefirewallsa-configure-firewalls"></a><a name="BKMK_ConfigureFirewalls"></a> 設定防火牆  
...
##  <a name="a-namebkmksyncsettingsa-plan-for-synchronization-settings"></a><a name="BKMK_SyncSettings"></a> 規劃同步處理設定  
...
###  <a name="a-namebkmksyncsourcea-synchronization-source"></a><a name="BKMK_SyncSource"></a> 同步處理來源  
...
###  <a name="a-namebkmksyncschedulea-synchronization-schedule"></a><a name="BKMK_SyncSchedule"></a> 同步處理排程  
...
###  <a name="a-namebkmkupdateclassificationsa-update-classifications"></a><a name="BKMK_UpdateClassifications"></a> 更新分類  
...
###  <a name="a-namebkmkupdateproductsa-products"></a><a name="BKMK_UpdateProducts"></a> 產品  
...
###  <a name="a-namebkmkupdatelanguagesa-languages"></a><a name="BKMK_UpdateLanguages"></a> 語言  
...
##  <a name="a-namebkmkmaintenancewindowa-plan-for-a-software-updates-maintenance-window"></a><a name="BKMK_MaintenanceWindow"></a> 規劃軟體更新維護期間  
...
##  <a name="a-namebkmkrestartoptionsa-restart-options-for-windows-10-clients-after-software-update-installation"></a><a name="BKMK_RestartOptions"></a> 提供在安裝軟體更新後重新啟動 Windows 10 用戶端的選項
