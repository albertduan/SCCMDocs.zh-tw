---
title: "建立憑證設定檔 | System Center Configuration Manager"
...
ms.sourcegitcommit: 91967314ccadcb59ce500ce36f79bbe35576dde8
ms.openlocfilehash: 04fd4cb7eb07e3fbb5d6a9a4604fcca87e440a6f


---
# <a name="how-to-create-certificate-profiles-in-system-center-configuration-manager"></a>如何在 System Center Configuration Manager 中建立憑證設定檔

*適用於︰System Center Configuration Manager (最新分支)*


使用憑證設定檔，透過受管理裝置存取公司資源所需的憑證來佈建受管理裝置。 建立憑證設定檔之前，請設定[設定 System Center Configuration Manager 的憑證基礎結構](certificate-infrastructure.md)中所述的憑證基礎結構。  
...
2.  使用下面的指導方針，完成 [建立憑證設定檔精靈] 的 [SCEP 註冊] 頁面。
