...
2.  在 軟體程式庫  工作區中，展開 作業系統 ，然後按一下驅動程式套件 。  
...
|<bpt id="p1">**</bpt>Properties<ept id="p1">**</ept>|開啟 [內容]  對話方塊，您可在其中檢閱並變更裝置驅動程式的內容與屬性。 例如，您可以變更裝置驅動程式的名稱與說明、啟用裝置驅動程式，並指定裝置驅動程式可在哪一個平台上執行。|  
...
2.  在 軟體程式庫  工作區中，展開 作業系統 ，然後按一下驅動程式 。  
...
6.  在 將驅動程式新增至套件  頁面上，選擇是否要將驅動程式新增到套件中，然後按一下下一步 。 請考慮以下列項目來將驅動程式新增至套件中：  
...
7.  在 將驅動程式新增至開機映像  頁面上，選擇是否要將裝置驅動程式新增至現有的開機映像，然後按一下下一步 。 如果您選取了開機映像，請考慮下列各項：  
...
4.  在 首頁  索引標籤的 驅動程式  群組中，按一下 編輯 ，然後按一下驅動程式套件 。  
...
4.  在 首頁  索引標籤的 驅動程式  群組中，按一下 編輯 ，然後按一下開機映像 。  
...
|<bpt id="p1">**</bpt>Properties<ept id="p1">**</ept>|開啟 [內容]  對話方塊，您可以在其中檢閱和變更裝置驅動程式的內容。 例如，您可以變更裝置驅動程式的名稱和描述、啟用裝置驅動程式，以及指定可以執行裝置驅動程式的平台。|  
...
3.  在 工作順序  節點中，選取您想要修改的工作順序以安裝裝置驅動程式，然後按一下編輯 。  
