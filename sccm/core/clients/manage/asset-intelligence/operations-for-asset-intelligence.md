...
3.  在 首頁  索引標籤的 建立  群組中，按一下 同步處理 ，然後按一下排程同步處理 。  
...
2.  在 資產與相容性  工作區中，按一下 Asset Intelligence ，然後按一下類別目錄 。  
...
2.  在 資產與相容性  工作區中，按一下 Asset Intelligence ，然後按一下硬體需求 。  
...
2.  在 資產與相容性  工作區中，按一下 Asset Intelligence ，然後按一下已清查的軟體 。  
...
3.  選取產品名稱，或選取要提交給 System Center Online 進行分類的多個產品名稱。 只有未分類的已清查軟體項目才能提交給 System Center Online 進行分類。 如果系統管理員已分類已清查的軟體項目而導致使用者定義的狀態，您必須在已清查的軟體項目上按一下滑鼠右鍵，然後按一下還原  先將軟體項目還原為 未分類  狀態，再將它提交給 System Center Online 進行分類。  
...
6.  選取 我已經閱讀並了解此訊息 ，然後按一下確定  允許提交選取的軟體項目進行分類。  
