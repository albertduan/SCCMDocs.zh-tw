...
-   註 2：從版本 1702 開始，站台伺服器或大部分站台系統角色將不會支援此作業系統，不過 1702 之前的版本會繼續支援使用此作業系統。 此作業系統仍會持續支援狀態移轉點和發佈點站台系統角色 (包括提取發佈點，以及針對 PXE 和多點傳送)，直到宣佈此支援已被取代，或是此作業系統的延伸支援期限過期。 從 1602 版開始，您可以將站台伺服器的作業系統從 Windows Server 2008 R2 就地升級到 Windows Server 2012 R2。  
