...
**當目前的界限群組不提供內容時︰**  
當目前界限群組的有效內容來源不提供用戶端要求的內容時，用戶端必須等到達到芳鄰界限群組或站台預設界限群組的後援期間，才能搜尋其他內容來源。

如果內容是依需求指定發佈，卻未依用戶端要求提供時，就會開始將內容傳送到目前界限發佈點的程序。  
...
##  <a name="BKMK_BoundaryBestPractices"></a> 界限的最佳做法  
