...
7.  根據您在步驟 6 中的選取項目，採取下列動作：  
    ...
    -   如果您選取 [與相關聯安全性角色相關的所有安全物件]，請選擇 [確定] 完成此程序。  
...
#### <a name="for-option-all-securable-objects-that-are-relevant-to-their-associated-security-roles"></a>針對選項：與相關聯安全性角色相關的所有安全物件  
...
5.  選擇 [安全性範圍] 索引標籤，確認系統管理使用者設定為使用 [與相關聯安全性角色相關的所有安全物件]。  
...
#### <a name="for-option-only-securable-objects-in-specified-security-scopes-or-collections"></a>針對選項：僅限指定的安全性範圍或集合中的安全物件  
...
5.  選擇 [安全性範圍] 索引標籤，確認使用者設定為使用 [僅限指定的安全性範圍或集合中的安全物件]。  
...
#### <a name="for-option-only-securable-objects-as-determined-by-the-security-roles-of-the-administrative-user"></a>針對選項：僅限系統管理使用者的安全性角色所決定的安全物件  
...
5.  選擇 [安全性範圍] 索引標籤，確認系統管理使用者設定為使用 [僅限指定的安全性範圍或集合中的安全物件]。  
