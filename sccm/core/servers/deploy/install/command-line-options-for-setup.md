 ...
 **/MANAGELANGS <*語言指令碼路徑*>**  
 管理之前已安裝網站所安裝的語言。 若要使用此選項，您必須從站台伺服器上的 **<*Configuration Manager 安裝路徑*>\BIN\X64** 執行安裝程式，並提供包含語言設定之語言指令碼檔案的位置。 如需語言安裝指令碼檔中可用語言選項的詳細資訊，請參閱本主題中的[用以管理語言的命令列選項](#bkmk_Lang) 。  
