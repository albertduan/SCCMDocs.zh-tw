...
||  
|-|  
|本文章包含\(最新分支\)的 System Center Configuration Manager [版本 1602 引入之新功能 (英文)](https://technet.microsoft.com/library/mt622084.aspx) 相關資訊。 若要使用新功能，您必須[安裝 1602 更新](https://technet.microsoft.com/library/mt607046.aspx)。 如果您尚未更新到最新版本的 Configuration Manager，您可以從 TechNet 組件庫[下載您所使用之版本的文件](https://gallery.technet.microsoft.com/Documentation-for-System-ea90eaf1)。|  
...
7.  在精靈的 [支援的平台]  頁面上，選取將評估組態項目的特定 Windows 平台。  
