...
ms.openlocfilehash: adaf5eeb29cbf43bf5708ab30485c1fb701c97c2
ms.lasthandoff: 03/06/2017


---
# <a name="how-to-create-configuration-items-for-windows-phone-devices-managed-with-intune"></a>如何建立使用 Intune 進行管理之 Windows Phone 裝置的設定項目
...
8.  在 [裝置設定] 頁面上，選取您想要設定的設定群組。 請參閱本主題的 [Windows Phone 設定項目設定參考](#windows-phone-configuration-item-settings-reference)以取得詳細資料，然後按 [下一步]。  
