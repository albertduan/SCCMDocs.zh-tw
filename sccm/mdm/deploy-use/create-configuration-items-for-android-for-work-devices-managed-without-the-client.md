...
7.  在精靈的 [裝置設定]  頁面上，選取您想要設定的設定群組。 請參閱本主題的 **Android 和 Samsung KNOX 組態項目設定參考** 以取得詳細資訊，然後按一下 [下一步] 。  
...
|設定名稱|詳細資料|  
|------------------|-------------|  
|**允許工作與個人設定檔之間的資料共用**|從下列選項進行選擇：<br>- **尚未設定**<br>- **禁止跨邊界共用**<br>- **工作設定檔中的應用程式可以處理來自個人設定檔的要求**<br>- **沒有共用限制**<br>|  
