...
Configuration Manager 提供選擇性抹除、完整抹除、遠端鎖定和密碼重設功能。 行動裝置可能儲存了公司機密資料，並可用來存取許多公司資源。 若要保護裝置，您可以發出：  
...
1.  在 Configuration Manager 主控台中，按一下 [資產與相容性]，再選取 [裝置]。 或者，您可以按一下 [裝置集合]  ，然後選取集合。  
...
## <a name="wiping-encrypting-file-system-efs-enabled-content"></a>抹除已啟用加密檔案系統 (EFS) 的內容  
...
### <a name="best-practices-for-selective-wipe"></a>選擇性抹除的最佳作法  
